...
def build_model():
    """
    Build Pipeline function from the model
    
    Output:
        ML Pipeline is generated that processes text messages and applies a classifier.
     """
    pipeline = Pipeline([
...
def main():
    """
    The main function of the train classifier. This function applies the Machine Learning Pipeline:
